...
ok("saveShopEdit in shop.js", "function saveShopEdit" in js_files['shop.js'])
...
ok("loadState loads shop_snapshot", "'shop_snapshot'" in sb_js)
...
ok("saveShopEdit function", "function saveShopEdit" in shop_js)
